	...
	<div class="banner-bottom">
		<div class="container">
			<div class="inner_sec_info_agileits_w3">
              <h2 class="heading-agileinfo">Message the Receiver<span>Kindly input your message to the Receiver</span></h2>
				<!-- <div class="contact-form"> -->
					 ...
					 <form action="">
					    	...
					    	<div>
						    	...
						    	<span><input type="textbox" name="userName" type="text" path="name" class="textbox"/></span>
						    </div>
						    <div>
						    	<span><label>Subject *</label></span>
						    	<span><input type="textbox" name="subject" type="text" path="subject" class="textbox"/></span>
						    </div>
					    ...
					    <div class="right_form">
								<div>					    	
									...
									<span><input type="textarea" name="Message" path="message" /> </span>
								</div>
							   <div>
									<span><input type="submit" value="Send Mail" class="myButton"></span>
							  </div>
					    </div>
					  <%--  </form:form> --%>
					  </form>
